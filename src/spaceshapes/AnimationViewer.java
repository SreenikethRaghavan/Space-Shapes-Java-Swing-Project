...
public class AnimationViewer extends JPanel implements ActionListener {
	...
	public AnimationViewer() {
		...
		_shapes.add(new DynamicShape(0, 30, 5, 3, Color.red)); */
		CarrierShape shape1 = new CarrierShape(1, 1, 3, 3, 200, 200, "Carrier Shape");
		Shape shape2 = new DynamicShape(20, 10, 3, 2, Color.yellow, "Snow");
		shape1.add(shape2);
		Shape shape3 = new HexagonShape(30, 30, 3, 2, 50, 60, "Bound Hexagon");
		shape1.add(shape3);

		CarrierShape shape4 = new CarrierShape(1, 1, 3, 3, 250, 250);
		shape4.add(shape1);
		_shapes.add(shape4);
